...
It is currently extremely difficult to unlock Xiaomi phones from the China region, especially if the device was imported and you are outside of China. To even begin the process, a Chinese account is required, which must be verified with a Chinese ID. In addition, the account must reach Community Level 5, and the user must pass a notoriously difficult exam. Even after passing the exam, the request still undergoes a review process. Based on recent reports, no applicants have successfully passed the exam or review this year.[Xiaomi BootLoader Questionnaire Questions](https://github.com/MlgmXyysd/Xiaomi-BootLoader-Questionnaire)
